(defproject io.logicblocks/component.jdbc.data-source.postgres "0.1.3-RC9"
  :description "A component providing a PostgreSQL JDBC data source."
  ...
  [[io.logicblocks/cartus.core "0.1.18"]
   ...
   [io.logicblocks/configurati "0.5.7-RC11"]
